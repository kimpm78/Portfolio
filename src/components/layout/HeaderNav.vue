...
<template>
  <header class="fixed left-0 top-0 z-[9999] h-[70px] w-full box-border">
    <div class="relative z-[9999] mx-auto flex h-full w-full items-center justify-between box-border px-[50px] text-white font-medium max-[1280px]:px-5 max-[680px]:block max-[680px]:px-0">
      <button
        type="button"
      ...
      <nav class="flex h-full items-center pl-[10px] max-[680px]:absolute max-[680px]:left-1/2 max-[680px]:top-1/2 max-[680px]:h-auto max-[680px]:-translate-x-1/2 max-[680px]:-translate-y-1/2 max-[680px]:p-0">
        <a href="/" aria-label="Prime Portfolio" @click.prevent="scrollToHome">
          <img
            :src="logoUrl"
